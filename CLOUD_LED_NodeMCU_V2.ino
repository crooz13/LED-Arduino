...
const char* ssid = "iPhone Murah"; // Nama WIFI kamu
const char* password = "oktavia05032000?"; // Password Wifi
const char* host = "192.168.43.246"; // Link website / Ip Server
...
String url = "192.168.43.246/cobacoba/baca-data.php?id=1"; // Lokasi File Baca Data
